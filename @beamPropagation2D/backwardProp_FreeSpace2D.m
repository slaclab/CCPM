%% <backwardProp_FreeSpace2D.m, Propagates a field backwards in z.>
...
function fList_Output = backwardProp_FreeSpace2D(this,z)

% Phase aquired by traveling a distance z backward in time
if isempty(this.field_phaseVec)
    phaseVec = conj( this.genPropPhase(z) ); % conj for the backwards version
else
    phaseVec = conj(this.field_phaseVec); % conj for the backwards version
end
